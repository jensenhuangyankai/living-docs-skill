...
- align a proposed change before implementation by grilling it against existing
  language, code, and documented decisions
- bootstrap living docs in a repo that does not have them yet
- navigate existing docs without loading the whole tree
- update docs after code changes

You do not need separate installs for alignment, bootstrap, navigation, or
updates. Those playbooks live inside the single `living-docs` skill as internal
references.
